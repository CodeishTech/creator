  ...
  return (
    <div align="center" justify="center">
      <div className="space-y-4 shadow-2xl dark:shadow-gray-400 p-4">
        ...
        <select class="border rounded w-full py-2 px-3 text-grey-darker bg-white" id="category" aria-label="Default select example" value={category} onChange={(e)=>setCategory(e.target.value)}>
        ...
        <br/>
        <div align="left" justify="left" className="text-white">
          <JoditEditor
            ref={editor}
            value={data}
            config={config}
